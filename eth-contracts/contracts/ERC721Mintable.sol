...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] != to, "Address is already the owner of this token");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(_exists(tokenId), "Approval for nonexistent token");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "Sender is not approved or owner");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == _tokenOwner[tokenId], "Invalid owner of this token");
        ...
        _ownedTokensCount[from].decrement();   //TEST
        _ownedTokensCount[to].increment();     //TEST
        _tokenOwner[tokenId] = to;
...
contract NonFungiblePropertyERC721Token is ERC721Metadata("OpenSea Non-Fungible Properties", "OSNFP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
